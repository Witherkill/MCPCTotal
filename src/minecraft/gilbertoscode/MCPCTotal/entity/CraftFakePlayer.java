package gilbertoscode.MCPCTotal.entity;
...
public class CraftFakePlayer extends CraftPlayer {
    ...
    private static final Map<String, EntityPlayerMP> fakePlayers = new HashMap<String, EntityPlayerMP>();
    // Map mod EntityPlayer class name to username (default or as configured) and doLogin settings
    private static final Map<String, String> fakePlayersUsername = new HashMap<String, String>();
    private static final Map<String, Boolean> fakePlayersDoLogin = new HashMap<String, Boolean>();
