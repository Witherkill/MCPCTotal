...
public class ModLoaderHelper {
    ...
    private static final Map<BaseModProxy, ModLoaderGuiHelper> guiHelpers = Maps.newHashMap();
    private static final Map<Integer, ModLoaderGuiHelper> guiIDs = Maps.newHashMap();
    private static final ModLoaderVillageTradeHandler[] tradeHelpers = new ModLoaderVillageTradeHandler[6];
