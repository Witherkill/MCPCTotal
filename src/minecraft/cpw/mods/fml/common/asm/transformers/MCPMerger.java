...
public class MCPMerger {
    ...
    private static final Hashtable<String, ClassInfo> clients = new Hashtable<String, ClassInfo>();
    private static final Hashtable<String, ClassInfo> shared = new Hashtable<String, ClassInfo>();
    private static final Hashtable<String, ClassInfo> servers = new Hashtable<String, ClassInfo>();
