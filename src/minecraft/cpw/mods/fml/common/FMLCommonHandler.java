...
public class FMLCommonHandler {
    ...
    private final List<IScheduledTickHandler> scheduledClientTicks = Lists.newArrayList();
    private final List<IScheduledTickHandler> scheduledServerTicks = Lists.newArrayList();
    private Class<?> forge;
    private boolean noForge;
    private List<String> brandings;
    private final List<ICrashCallable> crashCallables = Lists.newArrayList(Loader.instance().getCallableCrashInformation());
    private final Set<SaveHandler> handlerSet = Sets.newSetFromMap(new MapMaker().weakKeys().<SaveHandler, Boolean>makeMap());
