...
public class CoreFMLLibraries implements ILibrarySet {
    ...
    private static final String[] libraries = {"asm-all-4.1.jar", FMLInjectionData.debfuscationDataName()};
    private static final String[] checksums = {"054986e962b88d8660ae4566475658469595ef58", FMLInjectionData.deobfuscationDataHash};
    // MCPC+ end
