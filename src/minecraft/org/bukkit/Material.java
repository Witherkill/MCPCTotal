...
public enum Material {
    ...
    public static void addMaterial(int id, boolean isBlock) {
        addMaterial(id, "X" + id, isBlock);
    }

    public static void addMaterial(int id, String name, boolean isBlock) {
        if (byId[id] == null) {
            Material material = EnumHelper.addEnum(Material.class, name, new Class[]{Integer.TYPE, Boolean.TYPE}, new Object[]{Integer.valueOf(id), isBlock});
    ...
    private static void setFailsafeFieldValue(Field field, Object target, Object value) throws Exception {
        ...
        Object fieldAccessor = newFieldAccessor.invoke(reflectionFactory, field, Boolean.valueOf(false));
    ...
    public static <T extends Enum<?>> T replaceEnum(Class<T> enumType, String enumName, int ordinal, Class<?>[] paramTypes, Object[] paramValues) {
        ...
        try {
            ...
            setFailsafeFieldValue(valuesField, null, values.toArray((Object[]) Array.newInstance(enumType, 0)));
