...
public class PluginClassLoader extends URLClassLoader {
    ...
    private static final ConcurrentMap<Integer, JarMapping> jarMappings = new ConcurrentHashMap<Integer, JarMapping>();
    private final JavaPluginLoader loader;
    private final ConcurrentMap<String, Class<?>> classes = new ConcurrentHashMap<String, Class<?>>(); // MCPC+ - Threadsafe classloading
    // MCPC+ start
    private final JarRemapper remapper;     // class remapper for this plugin, or null
