...
import gilbertoscode.MCPCTotal.entity.*;
...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity) {
        ...
        if (entity instanceof net.minecraft.entity.EntityLiving) {
                ...
                if (entity instanceof net.minecraft.entity.passive.EntityAnimal) {
                    if (entity instanceof net.minecraft.entity.passive.EntityChicken) {
                        ...
                        if (entity instanceof net.minecraft.entity.passive.EntityWolf) {
                            ...
                            return new CraftCustomTameableAnimal(server, (net.minecraft.entity.passive.EntityTameable) entity);
                        } // MCPC+
                        ...
                        return new CraftCustomAnimal(server, (net.minecraft.entity.passive.EntityAnimal) entity);
                    } // MCPC+
                }
                // Monsters
                    ...
                    if (entity instanceof net.minecraft.entity.monster.EntityZombie) {
                        ...
                        return new CraftCustomMonster(server, (net.minecraft.entity.monster.EntityMob) entity);
                    } // MCPC+
                }
                // Water Animals
                    ...
                    if (entity instanceof net.minecraft.entity.passive.EntitySquid) {
                        ...
                        return new CraftCustomWaterMob(server, (net.minecraft.entity.passive.EntityWaterMob) entity);
                    } // MCPC+
                    ...
                    if (entity instanceof net.minecraft.entity.monster.EntitySnowman) {
                        ...
                        return new CraftCustomLivingEntity(server, (net.minecraft.entity.EntityLiving) entity);
                    } // MCPC+
                    ...
                    return new CraftCustomCreature(server, (net.minecraft.entity.EntityCreature) entity);
                } // MCPC+
            }
            ...
            // Ambient
                ...
                if (entity instanceof net.minecraft.entity.passive.EntityBat) {
                    ...
                    return new CraftCustomAmbient(server, (net.minecraft.entity.passive.EntityAmbientCreature) entity);
                } // MCPC+
            } else {
                return new CraftCustomLivingEntity(server, (net.minecraft.entity.EntityLiving) entity);
            } // MCPC+
        ...
        } else if (entity instanceof net.minecraft.entity.item.EntityFallingSand) {
            return new CraftFallingSand(server, (net.minecraft.entity.item.EntityFallingSand) entity);
            ...
            } // MCPC+ - other minecarts (Steve's Carts)
    ...
    public static Class<? extends org.bukkit.entity.Entity> getEntityClass(Class<? extends net.minecraft.entity.Entity> nmsClass) {
        ...
        if (net.minecraft.entity.EntityLiving.class.isAssignableFrom(nmsClass)) {
            ...
            if (net.minecraft.entity.player.EntityPlayer.class.isAssignableFrom(nmsClass)) {
                ...
                // Monsters
                    ...
                    if (net.minecraft.entity.monster.EntityZombie.class.isAssignableFrom(nmsClass)) {
                        ...
                        return CraftCustomMonster.class;
                    } // MCPC+
                }
                // Water Animals
                    ...
                    if (net.minecraft.entity.passive.EntitySquid.class.isAssignableFrom(nmsClass)) {
                        ...
                        return CraftCustomWaterMob.class;
                    } // MCPC+
            ...
            // Ambient
                ...
                if (net.minecraft.entity.passive.EntityBat.class.isAssignableFrom(nmsClass)) {
                    ...
                    return CraftCustomAmbient.class;
                } // MCPC+
            } else {
                return CraftCustomLivingEntity.class;
            } // MCPC+
        ...
        } else if (net.minecraft.entity.item.EntityFallingSand.class.isAssignableFrom(nmsClass)) {
