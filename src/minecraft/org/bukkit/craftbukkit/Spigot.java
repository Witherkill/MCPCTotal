...
public class Spigot {
    ...
    public static boolean initializeEntityActivationState(net.minecraft.entity.Entity entity, CraftWorld world) {
        return (entity.activationType == 3 && world.miscEntityActivationRange == 0)
    ...
    public static boolean checkEntityImmunities(net.minecraft.entity.Entity entity) {
        ...
        if (entity instanceof net.minecraft.entity.EntityLiving) {
            ...
            if (entity instanceof net.minecraft.entity.passive.EntityAnimal) {
                ...
                return entity instanceof net.minecraft.entity.passive.EntitySheep && ((net.minecraft.entity.passive.EntitySheep) entity).getSheared();
            }
        }
        return false;
    }
    ...
    public static void restart() {
        try {
            ...
            if (file.isFile()) {
                ...
                // Kick all players
                for (net.minecraft.entity.player.EntityPlayerMP p : (List<net.minecraft.entity.player.EntityPlayerMP>) MinecraftServer.getServer().getConfigurationManager().playerEntityList) {
