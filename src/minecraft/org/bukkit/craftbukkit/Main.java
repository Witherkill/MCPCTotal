...
public class Main {
    ...
    public static OptionSet loadOptions(String[] args) {
        ...
        try {
            ...
            FMLLog.getLogger().log(Level.SEVERE, ex.getLocalizedMessage());
        }
        ...
        if ((options == null) || (options.has("?"))) {
            try {
                ...
                FMLLog.getLogger().log(Level.SEVERE, null, ex);
            }
            ...
            try {
                ...
                try {
                    ...
                    FMLLog.getLogger().log(Level.SEVERE, "Could not save " + configFile, ex);
                }
                return options;
                // MCPC+ end
            } catch (Throwable t) {
