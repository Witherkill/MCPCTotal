...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender, cpw.mods.fml.common.network.Player // MCPC+ - marker interface
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (MCPCConfig.getDouble("mcpc.player-speed-max.land", -1) > 0 && this.landMovementFactor > MCPCConfig.getDouble("mcpc.player-speed-max.land", -1))
        {
            this.landMovementFactor = (float) MCPCConfig.getDouble("mcpc.player-speed-max.land", -1);
        }
        // MCPC+ end
