...
public class ChunkProviderServer implements IChunkProvider
{
     ...
     */
    public boolean loadChunkOnProvideRequest = MCPCConfig.loadChunkOnRequest; // MCPC+ - if true, allows mods to force load chunks. to disable, set load-chunk-on-request in mcpc.yml to false
