...
public class DimensionManager
{
    ...
    public static boolean registerProviderType(int id, Class<? extends WorldProvider> provider, boolean keepLoaded)
    {
        ...
        MCPCConfig.init();
        keepLoaded = MCPCConfig.getBoolean("world-environment-settings." + worldType + ".keep-world-loaded", keepLoaded);
        MCPCConfig.save();
        // MCPC+ end
    ...
    public static void initDimension(int dim) {
        ...
        try
        {
            ...
            if(MCPCConfig.craftWorldLoading)
            {
                return;
            }
            // MCPC+ end
        ...
        boolean enabled = MCPCConfig.getBoolean("world-environment-settings." + worldType + ".enabled", true);
        MCPCConfig.save();
        if (!enabled)
            return;
        // MCPC+ end
